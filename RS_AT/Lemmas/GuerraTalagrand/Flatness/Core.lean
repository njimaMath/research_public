-- Canonical implementation module for the shared GT-flatness theory.
import Lemmas.AT.PsiContinuity
...
/-!
Case-specific consequences live in `Lemmas.GuerraTalagrand.Flatness` modules.
