...
#check Equiv.Perm.extendDomain
#check Equiv.swap_apply_left
#check Equiv.swap_apply_right
#check Equiv.swap_apply_def
...
lemma localCavityCoordinate_error_test
  ...
  rw [abs_mul s, abs_mul (1 / (N : ℝ)), abs_of_nonneg hNinv] at htri
...
example (β q r A B C : ℝ) :
    β^2 * abstractRow q r A B C ee01 =
      (cavityMatrix β q r).mulVec ![A,B,C] 0 := by
  norm_num [abstractRow, abstractTerm, momentCoeff, ee01, ee02, ee03, ee12,
    ee13, ee23, ee04, ee14, ee24, ee34, ee45, edgeRelation,
    decoupledSpinCoefficient, cavityMatrix, Matrix.mulVec, dotProduct,
    Fin.sum_univ_succ]
  simp (disch := decide)
  ring

example (β q r A B C : ℝ) :
    β^2 * abstractRow q r A B C ee02 =
      (cavityMatrix β q r).mulVec ![A,B,C] 1 := by
  norm_num [abstractRow, abstractTerm, momentCoeff, ee01, ee02, ee03, ee12,
    ee13, ee23, ee04, ee14, ee24, ee34, ee45, edgeRelation,
    decoupledSpinCoefficient, cavityMatrix, Matrix.mulVec, dotProduct,
    Fin.sum_univ_succ]
...
example (β q r A B C : ℝ) :
    β^2 * abstractRow q r A B C ee23 =
      (cavityMatrix β q r).mulVec ![A,B,C] 2 := by
  norm_num [abstractRow, abstractTerm, momentCoeff, ee01, ee02, ee03, ee12,
    ee13, ee23, ee04, ee14, ee24, ee34, ee45, edgeRelation,
    decoupledSpinCoefficient, cavityMatrix, Matrix.mulVec, dotProduct,
    Fin.sum_univ_succ]
